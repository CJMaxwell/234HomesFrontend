        ...
        <div className="w-full signup bg-white rounded pb-16">
          ...
          <form className="px-8 mt-auto pb-12" onSubmit={handleSubmit}>
            <div className="border border-gray-200 justify-between flex items-center">
              <div>
                <img
                  src="/img/mailbox_icon.svg"
                  className="inline-block px-2 icon"
                  alt="Email icon"
                />
              </div>
              <input
                className="appearance-none focus:outline-none focus:bg-white w-full py-3 text-sm leading-tight"
                id="email"
                type="email"
                required
            ...
            <div className="flex my-4 justify-between w-full">
              <div className="border border-gray-200 w-1/2 mr-2 justify-between flex items-center">
                ...
                <input
                  className="appearance-none text-sm block w-full text-gray-700 py-3 leading-tight focus:outline-none focus:bg-white"
                  required
                  type="text"
              ...
              <div className="border border-gray-200 justify-between w-1/2 flex items-center">
                ...
                <input
                  className="appearance-none text-sm block w-full text-gray-700 py-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                  required
                  type="text"
            ...
            <div className="mt-12 flex mb-2">
              <input
                ...
                id="newsletter"
              />
              <label htmlFor="newsletter" className="inline-block text-xs">
                Yes! Send me genuinely useful emails every now and then to help me get the most out
                of +234Homes.
              </label>
            </div>
            <div className="flex">
              ...
              />
              <label htmlFor="termsandconditions" className="inline-block text-xs">
                Yes, I understand and agree to the{' '}
                <span className="agreement">+234Homes Terms of Service,</span> including the{' '}
                <span className="agreement">User Agreement</span> and <span>Privacy Policy.</span>
              </label>
            </div>
            <div className="text-center continue-email mt-8">
              <button
                ...
                type="submit"
                className="text-center w-full text-white my-3"
              >
                Create My Account
              </button>
            </div>
