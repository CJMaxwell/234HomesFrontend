...
const Membership = () => {
  return (
    <Wrapper>
      ...
      <section className="mt-16 plan-intro">
        <h1 className="text-center pricing-title">Membership Pricing</h1>
        <section className="flex justify-center">
          <p className="pricing-desc">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum.</p>
        </section>
        <section className="general-padding container mx-auto">
          <section className="flex justify-center items-center subscription-group">
            <section className="subscription free-plan mr-6">
              <h1 className="mem-option uppercase">Free</h1>
              <p className="pricing">NGN0.00 <span>/ Month</span></p>
              <ul className="offering">
                <li>Free Page</li>
                <li>Ability to upload 3 photos of products and contents</li>
                <li>Weekly Newsletter</li>
              </ul>
              <button type="button" className="free-btn uppercase py-3 px-16">Current plan</button>
            </section>
            <section className="subscription premium-plan mr-6">
              <h1 className="mem-option uppercase">PREMIUM</h1>
              <p className="pricing">NGN 10,000.00 <span>/ Month</span></p>
              <ul className="offering">
                <li>Free Page</li>
                <li>Ability to upload 3 photos of products and contents</li>
                <li>Weekly Newsletter</li>
              ...
              <button type="button" className="premium-btn uppercase py-3 px-20">Upgrade</button>
            </section>
            <section className="subscription plus-plan">
              <h1 className="mem-option uppercase">Plus</h1>
              <p className="pricing">NGN 5,000.00 <span>/ Month</span></p>
              <ul className="offering">
                <li>Free Page</li>
                <li>Ability to upload 3 photos of products and contents</li>
                <li>Weekly Newsletter</li>
              ...
              <button type="button" className="plus-btn uppercase py-3 px-20">Upgrade</button>
            </section>
          </section>
        </section>
