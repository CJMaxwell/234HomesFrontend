  ...
  return (
    <div>
      ...
      <section className="container mx-auto general-padding mt-20 mb-32 grid grid-cols-3 gap-12">
        <Favourite
          path="/productlist"
          imgUrl="/img/vendors/2-seat-orange-leather-sofa-beside-wall-1866149.png"
          height="15rem"
          width="22rem"
        ...
        <Favourite
          path="/productlist"
          imgUrl="/img/vendors/amber-kipp-79ePIEybmzQ-unsplash.png"
          height="15rem"
          width="22rem"
          title="Lighting"
        />
        ...
        <Favourite
          path="/productlist"
          imgUrl="/img/vendors/tiles-window-bathroom-marble-105934.png"
          height="15rem"
          width="22rem"
